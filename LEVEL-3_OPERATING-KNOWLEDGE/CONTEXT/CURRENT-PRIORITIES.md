...
2. SmartStore 주문조회 export와 판매 집계의 상품주문 수 일치를 기준선으로 삼아
   결제일·상품금액·환불금액 매핑과 데이터 Owner·기준시각을 확정
...
9. Hermes 자연어 접수, Task-ID·OS-Ref와 Revenue 작업 라우팅 구현
10. 내부 AI·Company OS의 매출 효과 측정 후 외부 상품 후보 검증
